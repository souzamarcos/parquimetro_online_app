...
const CriarNotificacaoDoTempoDaSessao = (data) => {
    console.log('CriarNotificacaoDoTempoDaSessao',data)
    PushNotification.localNotificationSchedule({
        ...
        date: data // in 60 secs
    });
}

const CancelarNotificacaoDoTempoDaSessao = () => {
    PushNotification.cancelLocalNotifications({id: '0'});
}

export default {
    CriarNotificacaoDoTempoDaSessao,
    CancelarNotificacaoDoTempoDaSessao
}